...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@tensorflow/tfjs-core'), require('@tensorflow/tfjs-data'), require('@tensorflow/tfjs-layers')) :
    typeof define === 'function' && define.amd ? define(['exports', '@tensorflow/tfjs-core', '@tensorflow/tfjs-data', '@tensorflow/tfjs-layers'], factory) :
    (factory((global.speechCommands = {}),global.tf,global.tf.data,global.tf));
}(this, (function (exports,tf,tfd,tfl) { 'use strict';
