...
jasmine_util_1.describeWithFlags('Browser FFT recognizer', jasmine_util_1.NODE_ENVS, function () {
    ...
    function setUpFakes(model, backgroundAndNoiseOnly) {
        ...
        tfLoadModelSpy =
            spyOn(tfl, 'loadLayersModel').and.callFake(function (url) {
                if (model == null) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, recognizer.ensureModelLoaded()];
                case 1:
                    _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, model.save("file://" + tmpDir)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    it('Constructing recognizer: custom URLs', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    tmpDir = tempfile();
                    return [4 /*yield*/, createFakeModelArtifact(tmpDir)];
                case 1:
                    _a.sent();
                ...
                case 2:
                    ...
                    return [4 /*yield*/, recognizer.recognize(tf.zeros([2, 43, 232, 1]))];
                case 3:
                    recogResult = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    recognizer = new browser_fft_recognizer_1.BrowserFftSpeechCommandRecognizer();
                    return [4 /*yield*/, recognizer.recognize(spectrogram)];
                case 1:
                    output = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, recognizer.recognize(spectrogram, { includeEmbedding: true })];
                case 1:
                    // Warm-up recognize call, for subsequent memory-leak check.
                    _a.sent();
    ...
    it('listen() call with invalid overlapFactor', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, recognizer.listen(function (result) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/];
                        }); }); }, { overlapFactor: -1.2 })];
                case 2:
                    _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, recognizer.stopListening()];
                    case 1:
                        _a.sent();
                        done();
                        _a.label = 2;
                    ...
                    case 0:
                        ...
                        if (callbackTimestamps.length > 1) {
                            expect(callbackTimestamps[callbackTimestamps.length - 1] -
                                callbackTimestamps[callbackTimestamps.length - 2])
                                .toBeGreaterThanOrEqual(recognizer.params().spectrogramDurationMillis - timeDelta);
                        }
                        tensorCounts.push(tf.memory().numTensors);
                        // spectrogram is not provided by default.
                        expect(result.spectrogram).toBeUndefined();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, recognizer.recognize()];
                case 2:
                    output = _a.sent();
    ...
    it('Online recognize() call with includeEmbedding succeeds', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    if (!(i < 2)) return [3 /*break*/, 4];
                    return [4 /*yield*/, recognizer.recognize(null, { includeEmbedding: true })];
                case 2:
                    output = _a.sent();
                    expect(output.scores.length).toEqual(fakeWords.length);
                    expect(output.embedding.rank).toEqual(2);
    ...
    it('Online recognize() call with includeSpectrogram succeeds', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    if (!(i < 2)) return [3 /*break*/, 4];
                    return [4 /*yield*/, recognizer.recognize(null, { includeSpectrogram: true })];
                case 2:
                    output = _a.sent();
                    expect(output.scores.length).toEqual(fakeWords.length);
                    expect(output.embedding).toBeUndefined();
    ...
    it('collectExample: durationMultiplier&durationSec errors', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, transfer.collectExample('foo', { durationSec: durationSec, durationMultiplier: durationMultiplier })];
                case 3:
                    _a.sent();
                    done.fail('Failed to catch expected error');
                    return [3 /*break*/, 5];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    snippetLengths = [];
                    return [4 /*yield*/, transfer.collectExample('foo', {
    ...
    it('collectExample w/ invalid durationSec leads to error', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, transfer.collectExample('foo', { durationSec: durationSec, snippetDurationSec: snippetDurationSec })];
                case 3:
                    _a.sent();
                    done.fail();
                    return [3 /*break*/, 5];
    ...
    it('collectExample w/ onSnippet w/o snippetDurationSec error', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, transfer.collectExample('foo', { durationSec: durationSec, onSnippet: function (spectrogram) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2 /*return*/];
                            }); }); } })];
                case 3:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, transfer.collectExample('foo', { durationSec: durationSec, includeRawAudio: includeRawAudio })];
                case 2:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, transfer.collectExample('bar')];
                case 4:
                    spectrogram = _a.sent();
                    expect(spectrogram.frameSize).toEqual(fakeColumnTruncateLength);
                    expect(spectrogram.data.length)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, transfer1.collectExample('foo')];
                case 2:
                    spectrogram = _a.sent();
                    expect(spectrogram.frameSize).toEqual(fakeColumnTruncateLength);
                    expect(spectrogram.data.length)
                    ...
                    return [4 /*yield*/, base.createTransfer('xfer2')];
                case 3:
                    transfer2 = _a.sent();
                    return [4 /*yield*/, transfer2.collectExample('bar')];
                case 4:
                    spectrogram = _a.sent();
                    expect(spectrogram.frameSize).toEqual(fakeColumnTruncateLength);
                    expect(spectrogram.data.length)
    ...
    it('collectExample fails on undefined/null/empty word', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, transfer.collectExample(undefined)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                ...
                case 6:
                    _a.trys.push([6, 8, , 9]);
                    return [4 /*yield*/, transfer.collectExample(null)];
                case 7:
                    _a.sent();
                    return [3 /*break*/, 9];
                case 8:
                ...
                case 10:
                    ...
                    return [4 /*yield*/, transfer.collectExample('')];
                case 11:
                    _a.sent();
                    return [3 /*break*/, 13];
                case 12:
    ...
    it('Concurrent collectTransferLearningExample call fails', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, base.createTransfer('xfer1')];
                case 2:
                    transfer1 = _a.sent();
    ...
    it('Concurrent collectExample+listen fails', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, base.listen(function (result) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/];
                        }); }); })];
                case 2:
                    _a.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, base.stopListening()];
                case 4:
                    _a.sent();
    ...
    it('trainTransferLearningModel default params', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                return [4 /*yield*/, transfer.train({ epochs: 1, optimizer: tf.train.sgd(0) })];
                case 7:
                    // Train transfer-learning model once to make sure model is created
                    // first, so that we can check the change in the transfer-learning model's
                    // weights after a new round of training.
                    ...
                    return [4 /*yield*/, transfer.train({ optimizer: tf.train.sgd(1) })];
                case 8:
                    history = _d.sent();
                    ...
                    maxWeightChanges = newTransferWeightValues.map(function (newValues, i) { return tf.max(tf.abs(tf.sub(tf.tensor1d(newValues), tf.tensor1d(oldTransferWeightValues[i]))))
                        .dataSync()[0]; });
                    expect(Math.max.apply(Math, __spread(maxWeightChanges))).toBeGreaterThan(1e-3);
                    spectrogram = tf.zeros([1, fakeNumFrames, fakeColumnTruncateLength, 1]);
                    return [4 /*yield*/, transfer.recognize(spectrogram)];
                case 9:
                    result = _d.sent();
                    ...
                    transfer.listen(function (result) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    expect(result.scores.length).toEqual(2);
                                    return [4 /*yield*/, transfer.stopListening()];
                                case 1:
                                    _a.sent();
                                    done();
                                    return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ++i;
                    return [3 /*break*/, 3];
                case 6: return [4 /*yield*/, transfer.train({ epochs: 10, batchSize: 2 })];
                case 7:
                    history = _a.sent();
    ...
    it('trainTransferLearningModel w/ mixing-noise augmentation', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    if (!(i < 2)) return [3 /*break*/, 6];
                    return [4 /*yield*/, transfer.collectExample(dataset_1.BACKGROUND_NOISE_TAG)];
                case 4:
                    _a.sent();
                    _a.label = 5;
                case 5:
                    ++i;
                    return [3 /*break*/, 3];
                case 6: return [4 /*yield*/, transfer.train({ epochs: 10, batchSize: 2, augmentByMixingNoiseRatio: 0.5 })];
                case 7:
                    history = _a.sent();
                    expect(history.history.loss.length).toEqual(10);
                    expect(history.history.acc.length).toEqual(10);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    transfer = base.createTransfer('xfer1');
                    return [4 /*yield*/, transfer.collectExample('_background_noise_')];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, transfer.collectExample('bar')];
                case 3:
                ...
                case 4:
                    _b.sent();
                    return [4 /*yield*/, transfer.train({ epochs: 3, batchSize: 2, validationSplit: 0.5 })];
                case 5:
                    _b.sent();
                    wordProbThresholds = [0, 0.25, 0.5, 0.75, 1];
                    // Burn-in run for evaluate() memory tracking:
                    return [4 /*yield*/, transfer.evaluate({ windowHopRatio: 0.25, wordProbThresholds: wordProbThresholds })];
                case 6:
                    // Burn-in run for evaluate() memory tracking:
                    _b.sent();
                    numTensors0 = tf.memory().numTensors;
    ...
    it('getMetadata works after transfer learning', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    _a.sent();
                    return [4 /*yield*/, transfer.train({ epochs: 1, batchSize: 2, validationSplit: 0.5 })];
                case 5:
                    _a.sent();
    ...
    it('loadExapmles, from empty state', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, transfer1.collectExample('bar')];
                case 3:
                    _a.sent();
                    ...
                    return [4 /*yield*/, transfer2.collectExample('qux')];
                case 4:
                    // Assert that transfer2 can continue to collect new examples.
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    transfer = base.createTransfer('xfer1');
                    return [4 /*yield*/, transfer.collectExample('foo', { durationMultiplier: 1.5 })];
                case 2:
                    spectrogram = _a.sent();
                    expect(spectrogram.frameSize).toEqual(fakeColumnTruncateLength);
    ...
    function setUpFakeIndexedDB(artifactStore) {
        var FakeIndexedDBHandler = /** @class */ (function () {
            ...
            FakeIndexedDBHandler.prototype.load = function () {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, this.artifactStore[this.artifactStore.length - 1]];
                    });
                });
            };
    ...
    it('Save and load transfer model via indexeddb://', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, transfer.train({ epochs: 1 })];
                case 4:
                    _a.sent();
                    xs = tf.ones([1, fakeNumFrames, fakeColumnTruncateLength, 1]);
                    return [4 /*yield*/, transfer.recognize(xs)];
                case 5:
                    out0 = _a.sent();
                ...
                case 6:
                    ...
                    return [4 /*yield*/, tfl.models.modelFromJSON(indexedDBStore[0].modelTopology)];
                case 7:
                    modelPrime = _a.sent();
                    ...
                    return [4 /*yield*/, base2.ensureModelLoaded()];
                case 8:
                    _a.sent();
                    ...
                    return [4 /*yield*/, transfer2.load()];
                case 9:
                    _a.sent();
                    expect(transfer2.wordLabels()).toEqual(['bar', 'foo']);
                    return [4 /*yield*/, transfer2.recognize(xs)];
                case 10:
                    out1 = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, transfer.save("file://" + tempSavePath)];
                case 5:
                    _a.sent();
                    // Disable the spy on tf.loadLayersModel() first, so the subsequent
                    // tf.loadLayersModel() call during the load() call can use the fake
                    // IndexedDB handler created above.
                    tfLoadModelSpy.and.callThrough();
                    return [4 /*yield*/, tfl.loadLayersModel("file://" + tempSavePath + "/model.json")];
                case 6:
                    modelPrime = _a.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = expect;
                    return [4 /*yield*/, browser_fft_recognizer_1.listSavedTransferModels()];
                case 1:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, browser_fft_recognizer_1.deleteSavedTransferModel('foo')];
                case 1:
                    _a.sent();
